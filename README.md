...
Feel free to check the [issues page](https://github.com/mikemtzp/Morsecode-decoder/issues).
...
[MIT License](https://github.com/mikemtzp/Morsecode-decoder/blob/dev/LICENSE)
